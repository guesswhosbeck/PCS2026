...
#include <optional> /* serve per casi in cui nodo non appartiene a grafo in neighbours */
...
// costruirò un grafo di 10 nodi attraverso una matrice 10x10 simmetrica
template<typename I> requires std::integral<I>
class undirected_graph
{
	...
	std::optional<std::set<I>> neighbours(const I& nodo) const {
